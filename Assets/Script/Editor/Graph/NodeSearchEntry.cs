        ...
        public bool OnSelectEntry(SearchTreeEntry SearchTreeEntry, SearchWindowContext context)
        {
            ...
            if (graphAssetDrawer != null)
            {
                ...
                if (nodeMetaData.nodeType != null)
                {
                    ...
                    {
                        if (!nodeCreateLimitAttribute.CanCreate(graphAssetDrawer.GetGraphAsset(), nodeMetaData.nodeType))
                        {
                            return false;
                        }
                    }
                    BaseNodeDrawer nodeDrawer = BaseNodeDrawer.Allocate(nodeMetaData.nodeType);
                    if (nodeDrawer != null)
                    {
