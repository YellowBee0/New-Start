Shader "UI/Particles/AlphaControl"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata_t v)
            {
                ...
                // ParticleSystemRenderer supplies the per-particle color here.
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                // This is the material-level alpha control.
                color.a *= _Alpha;
